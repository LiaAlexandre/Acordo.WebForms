...
<asp:Content ID="BodyCadastro" ContentPlaceHolderID="MainContent" runat="server" Visible="false">
    <asp:Panel ID="CadastroPanel" runat="server" BackColor="Black" ForeColor="White" GroupingText="Cadastro"  class="contentPlaceHolder">
        <asp:Panel ID="Panel2" runat="server" BackColor="Black" BorderStyle="None">
